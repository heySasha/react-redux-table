...
export function addClassroom(id_classroom = ++lastId, number_classroom, count_places, id_building) {
    return axios.post('/api/classrooms', { id_classroom, number_classroom, count_places, id_building })
        .then(res => res.data)
        .then(classroom => ({
            type: ADD_CLASSROOM,
            classroom
...
export function deleteClassroom(id_classroom) {
    return axios.delete(`/api/classrooms/${id_classroom}`)
        .then(res => ({
...
export function editClassroom(id_classroom, number_classroom, count_places, id_building) {
    return axios.put(`/api/classrooms/${id_classroom}`, { id_classroom, number_classroom, count_places, id_building })
        .then(res => res.data)
        .then(classroom => ({
            type: EDIT_CLASSROOM,
            classroom
